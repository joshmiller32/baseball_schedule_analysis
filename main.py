...
@st.cache(persist = True, suppress_st_warning = True)
def pct_of_games_against_500_teams(dataframes):
...
@st.cache(persist = True, suppress_st_warning = True)
def number_of_games_against_500_teams(dataframes):
    dataframes = get_schedule_df()
    games_over_500_dfs = []
    for df in dataframes:
...
def main():
    ...
    games_500 = number_of_games_against_500_teams(dataframes)
    ...
    pct_of_games_against_500_teams_dfs = pct_of_games_against_500_teams(dataframes)
    ...
    opp_win_pct_dfs = opp_win_pct(dataframes)
